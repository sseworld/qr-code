...
>(name: string) {
  ...
  type ContextValue = {
    ...
    setItemMap: React.Dispatch<
      React.SetStateAction<ItemMap<ItemElement, ItemData>>
    >;
  };
  ...
  const CollectionProviderImpl: React.FC<{
    ...
    const [collectionElement, setCollectionElement] =
      React.useState<CollectionElement | null>(null);
  ...
  const CollectionSlot = React.forwardRef<CollectionElement, CollectionProps>(
    (props, forwardedRef) => {
      ...
      return (
        <CollectionSlotImpl ref={composedRefs}>{children}</CollectionSlotImpl>
      );
    }
  );
