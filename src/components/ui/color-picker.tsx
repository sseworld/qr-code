...
export const ColorPickerSelection = React.memo(
...
export const ColorPickerHue = ({
  ...
  return (
    <Slider.Root
      ...
      max={360}
      onValueChange={([hue]: any) => setHue(hue)}
      step={1}
      value={[hue]}
      {...props}
    >
...
export const ColorPickerAlpha = ({
  ...
  return (
    <Slider.Root
      className={cn("relative flex h-4 w-full touch-none", className)}
      max={100}
      onValueChange={([alpha]: any) => setAlpha(alpha)}
      step={1}
      value={[alpha]}
      {...props}
    >
...
export type ColorPickerOutputProps = React.ComponentProps<
...
export const ColorPickerOutput = ({
  ...
  return (
    <SelectPrimitive.Select onValueChange={setMode} value={mode}>
...
type PercentageInputProps = React.ComponentProps<typeof Input>;
